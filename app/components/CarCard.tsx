 ...
 */
const CarCard: React.FC<CarCardProps> = ({ name, type, seats, luggage, gearshift, images, priceKsh, topSpeed, brakesType, fuelConsumption, acceleration, torque, gasTankCapacity }) => {
  ...
  return (
    <div className="car-card">
      ...
      <div className="car-info">
        ...
        {(topSpeed || brakesType || fuelConsumption || acceleration || torque || gasTankCapacity) && (
        ...
        <button className="order-now-btn" onClick={() => router.push('/order')}>
          Order Now
        </button>
      </div>
      <style jsx>{`
        .car-card {
          background: radial-gradient(ellipse at 60% 40%, #bfc8d6 0%, #18191a 100%);
          color: #fff;
          border-radius: 18px;
          overflow: hidden;
